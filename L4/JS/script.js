  ...
  $.ajax({
    ...
    success: function(result) {
      $.each(result.catalog_items, function(index, item) {
        ...
        $(catalogs).find(".catalog-short_name").html(datas[i].short_name);
        $(catalogs).find(".catalog-name").html(datas[i].name);
        $(catalogs).find(".catalog-description").html(datas[i].description);
        $(catalogs).find(".catalog-price_retail").html(datas[i].price_retail);
        $(catalogs).find(".catalog-price_wholesale").html(datas[i].price_wholesale);
        $(catalogs).find(".catalog-amount_retail").html(datas[i].amount_retail);
        $(catalogs).find(".catalog-amount_wholesale").html(datas[i].amount_wholesale);
        
        //$(catalogs).find(".catalog-img").attr("src", "images/catalog/" + categoryShortName + "/" + datas[i].short_name + ".jpg");
